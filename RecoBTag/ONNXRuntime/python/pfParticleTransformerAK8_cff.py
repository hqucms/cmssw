...
pfParticleTransformerAK8MDJetTags = boostedJetONNXJetTagsProducer.clone(
    ...
    preprocess_json = 'RecoBTag/Combined/data/ParticleNetAK8/General/V01/preprocess.json',  # FIXME
    model_path = 'RecoBTag/Combined/data/ParticleNetAK8/General/V01/modelfile/model.onnx',  # FIXME
    flav_names = [
