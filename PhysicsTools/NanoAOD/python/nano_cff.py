...
def nanoAOD_addDeepInfo(process,addDeepBTag,addDeepFlavour, addParticleNetAK4Tau):
    _btagDiscriminators=[]
    if addDeepBTag:
    ...
    if addParticleNetAK4Tau:
        print("Updating process to run ParticleNetAK4Tau before it's included in MiniAOD")
        from RecoBTag.ONNXRuntime.pfParticleNetAK4Tau_cff import _pfParticleNetAK4TauJetTagsAll as pfParticleNetAK4TauJetTagsAll
        _btagDiscriminators += pfParticleNetAK4TauJetTagsAll
...
def nanoAOD_addDeepInfoAK8(process, addDeepBTag, addDeepBoostedJet, addDeepDoubleX, addDeepDoubleXV2, addParticleNet, addParticleNetTau, addParticleNetMass, jecPayload):
    _btagDiscriminators=[]
    if addDeepBTag:
    ...
    if addParticleNetTau:
        print("Updating process to run ParticleNetTau before it's included in MiniAOD")
        from RecoBTag.ONNXRuntime.pfParticleNetTau_cff import _pfParticleNetTauJetTagsAll as pfParticleNetTauJetTagsAll
        _btagDiscriminators += pfParticleNetTauJetTagsAll
...
def nanoAOD_customizeCommon(process):
    ...
    nanoAOD_addDeepInfo_switch = cms.PSet(
        ...
        nanoAOD_addParticleNetAK4Tau_switch = cms.untracked.bool(False),
        )
    ...
    process = nanoAOD_addDeepInfo(process,
                                  ...
                                  addParticleNetAK4Tau=nanoAOD_addDeepInfo_switch.nanoAOD_addParticleNetAK4Tau_switch)
    nanoAOD_addDeepInfoAK8_switch = cms.PSet(
        ...
        nanoAOD_addParticleNetTau_switch = cms.untracked.bool(True),
    ...
    process = nanoAOD_addDeepInfoAK8(process,
                                     ...
                                     addParticleNetTau=nanoAOD_addDeepInfoAK8_switch.nanoAOD_addParticleNetTau_switch,
