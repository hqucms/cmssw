...
jetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        particleNetAK4Tau_b          = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probb')",float,doc="ParticleNet b tag discriminator",precision=10),
        particleNetAK4Tau_c          = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probc')",float,doc="ParticleNet c tag discriminator",precision=10),        
        particleNetAK4Tau_uds        = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probuds')",float,doc="ParticleNet uds tag discriminator",precision=10),
        particleNetAK4Tau_g          = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probg')",float,doc="ParticleNet g tag discriminator",precision=10),
        particleNetAK4Tau_mu         = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probmu')",float,doc="ParticleNet mu tag discriminator",precision=10),
        particleNetAK4Tau_el         = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probele')",float,doc="ParticleNet ele tag discriminator",precision=10),
        particleNetAK4Tau_tau1h0p    = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probtau1h0p')",float,doc="ParticleNet tau1h0p tag discriminator",precision=10),
        particleNetAK4Tau_tau1h1or2p = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probtau1h1or2p')",float,doc="ParticleNet tau1h1or2p tag discriminator",precision=10),
        particleNetAK4Tau_tau3h0p    = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probtau3h0p')",float,doc="ParticleNet tau3h0p tag discriminator",precision=10),
        particleNetAK4Tau_tau3h1p    = Var("bDiscriminator('pfParticleNetAK4TauJetTags:probtau3h1p')",float,doc="ParticleNet tau3h1p tag discriminator",precision=10),
        particleNetAK4Tau_ptVis      = Var("bDiscriminator('pfParticleNetAK4TauJetTags:ptvis')",float,doc="ParticleNet visible pt regression",precision=10),
        particleNetAK4Tau_ptWithNu   = Var("bDiscriminator('pfParticleNetAK4TauJetTags:ptnu')",float,doc="ParticleNet pt (with neutrino) regression",precision=10),
...
fatJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        particleNetTauMD_Xbb = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probXbb')",float,doc="Mass-decorrelated ParticleNetTau tagger raw X->bb score. For X->bb vs QCD tagging, use Xbb/(Xbb+QCD)",precision=10),
        particleNetTauMD_Xcc = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probXcc')",float,doc="Mass-decorrelated ParticleNetTau tagger raw X->cc score. For X->cc vs QCD tagging, use Xcc/(Xcc+QCD)",precision=10),
        particleNetTauMD_Xqq = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probXqq')",float,doc="Mass-decorrelated ParticleNetTau tagger raw X->qq score. For X->qq vs QCD tagging, use Xcc/(Xqq+QCD)",precision=10),
        particleNetTauMD_Xtt = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probXtt')",float,doc="Mass-decorrelated ParticleNetTau tagger raw X->bb score. For X->tt vs QCD tagging, use Xtt/(Xtt+QCD)",precision=10),
        particleNetTauMD_Xtm = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probXtm')",float,doc="Mass-decorrelated ParticleNetTau tagger raw X->bb score. For X->tm vs QCD tagging, use Xtm/(Xtm+QCD)",precision=10),
        particleNetTauMD_Xte = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probXte')",float,doc="Mass-decorrelated ParticleNetTau tagger raw X->bb score. For X->te vs QCD tagging, use Xte/(Xte+QCD)",precision=10),
        particleNetTauMD_Xmm = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probXmm')",float,doc="Mass-decorrelated ParticleNetTau tagger raw X->bb score. For X->mm vs QCD tagging, use Xmm/(Xmm+QCD)",precision=10),
        particleNetTauMD_Xee = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probXee')",float,doc="Mass-decorrelated ParticleNetTau tagger raw X->bb score. For X->ee vs QCD tagging, use Xee/(Xee+QCD)",precision=10),
        particleNetTauMD_Xgg = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probXgg')",float,doc="Mass-decorrelated ParticleNetTau tagger raw X->gg score. For X->gg vs QCD tagging, use Xgg/(Xgg+QCD)",precision=10),
        particleNetTauMD_QCD = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:probQCD')",float,doc="Mass-decorrelated ParticleNetTau tagger raw QCD score.",precision=10),
        particleNetTauMD_mass = Var("bDiscriminator('pfMassDecorrelatedParticleNetTauJetTags:mass')",float,doc="Mass-decorrelated ParticleNetTau mass regression.",precision=10),
