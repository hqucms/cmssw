    ...
    vplots = cms.PSet(
        ...
        Jet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('particleNetAK4_B', 'particleNetAK4_B', 20, 0, 1, 'ParticleNetAK4 tagger b vs all (udsg, c) discriminator'),
                Plot1D('particleNetAK4_CvsB', 'particleNetAK4_CvsB', 20, 0, 1, 'ParticleNetAK4 tagger c vs b discriminator'),
                Plot1D('particleNetAK4_CvsL', 'particleNetAK4_CvsL', 20, 0, 1, 'ParticleNetAK4 tagger c vs udsg discriminator'),
                Plot1D('particleNetAK4_QvsG', 'particleNetAK4_QvsG', 20, 0, 1, 'ParticleNetAK4 tagger uds vs g discriminator'),
                Plot1D('particleNetAK4_puIdDisc', 'particleNetAK4_puIdDisc', 20, 0, 1, 'ParticleNetAK4 tagger pileup jet discriminator'),
                Plot1D('partonFlavour', 'partonFlavour', 40, -9.5, 30.5, 'flavour from parton matching'),
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'phi'),
                Plot1D('pt', 'pt', 20, 0, 400, 'pt'),
