...
steps['BTVNANO_mc15.0'] = merge([{'-s': 'NANO:@BTV', '-n': '1000'},
                                 steps['NANO_mc15.0']])

steps['lepTrackInfoNANO_mc15.0'] = merge([{'-s': 'NANO:@LepTrackInfo,DQM:@nanoAODDQM', '-n': '1000'},
                                          steps['NANO_mc15.0']])

steps['jmeNANO_mc15.0'] = merge([{'-s': 'NANO:@JME', '-n': '1000'},
                                 steps['NANO_mc15.0']])

steps['jmeNANO_rePuppi_mc15.0'] = merge([{'-s': 'NANO:@JMErePuppi', '-n': '1000'},
                                         steps['NANO_mc15.0']])
...
steps['BTVNANO_data15.0'] = merge([{'-s': 'NANO:@BTV', '-n': '1000'},
                                   steps['NANO_data15.0']])

steps['lepTrackInfoNANO_data15.0'] = merge([{'-s': 'NANO:@LepTrackInfo,DQM:@nanoAODDQM', '-n': '1000'},
                                           steps['NANO_data15.0']])

steps['jmeNANO_data15.0'] = merge([{'-s': 'NANO:@JME', '-n': '1000'},
                                   steps['NANO_data15.0']])

steps['jmeNANO_rePuppi_data15.0'] = merge([{'-s': 'NANO:@JMErePuppi', '-n': '1000'},
                                          steps['NANO_data15.0']])
