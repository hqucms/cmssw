...
steps['muPOGNANO_mc13.0'] = merge([{'-s': 'NANO:@MUPOG,DQM:@nanoAODDQM', '-n': '1000'},
                                   steps['NANO_mc13.0']])

steps['EGMNANO_mc13.0'] = merge([{'-s': 'NANO:@EGM,DQM:@nanoAODDQM', '-n': '1000'},
                                 steps['NANO_mc13.0']])

steps['BTVNANO_mc13.0'] = merge([{'-s': 'NANO:@BTV', '-n': '1000'},
                                 steps['NANO_mc13.0']])

steps['lepTrackInfoNANO_mc13.0'] = merge([{'-s': 'NANO:@LepTrackInfo,DQM:@nanoAODDQM', '-n': '1000'},
                                          steps['NANO_mc13.0']])

steps['jmeNANO_mc13.0'] = merge([{'-s': 'NANO:@JME ', '-n': '1000'},
                                 steps['NANO_mc13.0']])

steps['jmeNANO_rePuppi_mc13.0'] = merge([{'-s': 'NANO:@JMErePuppi ', '-n': '1000'},
                                         steps['NANO_mc13.0']])
...
steps['ZMuSkim2023RAWRECO13.0'] = {'INPUT': InputInfo(location='STD', ls={370775: [[1, 168]]},
                                                      dataSet='/Muon0/Run2023D-ZMu-PromptReco-v2/RAW-RECO')}

steps['ZeroBias2023RAW13.0'] = {'INPUT': InputInfo(location='STD', ls={369978: [[1, 800]]},
                                                   dataSet='/ZeroBias/Run2023D-v1/RAW')}

steps['TestEnablesEcalHcal2023RAW13.0'] = {'INPUT': InputInfo(location='STD', ls={368489: [[46, 546]]},
...
steps['BTVNANO_data13.0'] = merge([{'-s': 'NANO:@BTV', '-n': '1000'},
                                   steps['NANO_data13.0']])

steps['lepTrackInfoNANO_data13.0'] = merge([{'-s': 'NANO:@LepTrackInfo,DQM:@nanoAODDQM', '-n': '1000'},
                                           steps['NANO_data13.0']])
...
# DPG custom NANO
steps['muDPGNANO_data13.0'] = merge([{'-s': 'RAW2DIGI,NANO:@MUDPG', '-n': '100'},
                                     steps['NANO_data13.0']])

steps['muDPGNANOBkg_data13.0'] = merge([{'-s': 'RAW2DIGI,NANO:@MUDPGBKG', '-n': '100'},
                                        steps['NANO_data13.0']])

steps['hcalDPGNANO_data13.0'] = merge([{'-s': 'RAW2DIGI,RECO,NANO:@HCAL', '-n': '100',
                                        '--processName': 'NANO'},
                                       steps['NANO_data13.0']])

steps['hcalDPGCalibNANO_data13.0'] = merge([{'-s': 'RAW2DIGI,RECO,NANO:@HCALCalib', '-n': '100',
                                             '--processName': 'NANO'},
                                            steps['NANO_data13.0']])

steps['l1DPGNANO_data13.0'] = merge([{'-s': 'RAW2DIGI,NANO:@L1DPG', '-n': '100'},
                                     steps['NANO_data13.0']])
...
steps['TestEnablesEcalHcal2024RAW14.0'] = {'INPUT': InputInfo(location='STD', ls={382874: [[14, 25]]},
...
_wfn.subnext()
# workflows[_wfn()] = ['muPOGNANOmc130X', ['TTbarMINIAOD13.0', 'muPOGNANO_mc13.0']]
# workflows[_wfn()] = ['EGMNANOmc130X', ['TTbarMINIAOD13.0', 'EGMNANO_mc13.0']]
# workflows[_wfn()] = ['BTVNANOmc130X', ['TTbarMINIAOD13.0', 'BTVNANO_mc13.0']]
# workflows[_wfn()] = ['jmeNANOmc130X', ['TTbarMINIAOD13.0', 'jmeNANO_mc13.0']]
# workflows[_wfn()] = ['jmeNANOrePuppimc130X', ['TTbarMINIAOD13.0', 'jmeNANO_rePuppi_mc13.0']]
# workflows[_wfn()] = ['lepTrackInfoNANOmc130X', ['TTbarMINIAOD13.0', 'lepTrackInfoNANO_mc13.0']]
...
# workflows[_wfn()] = ['BTVNANOdata130Xrun3', ['MuonEG2023MINIAOD13.0', 'BTVNANO_data13.0']]
...
_wfn.subnext()
# workflows[_wfn()] = ['l1DPGNANO130Xrun3', ['ZMuSkim2023RAWRECO13.0', 'l1DPGNANO_data13.0']]
# workflows[_wfn()] = ['muDPGNANO130Xrun3', ['ZMuSkim2023RAWRECO13.0', 'muDPGNANO_data13.0']]
# workflows[_wfn()] = ['muDPGNANOBkg130Xrun3', ['ZeroBias2023RAW13.0', 'muDPGNANOBkg_data13.0']]
# workflows[_wfn()] = ['hcalDPGNANO130Xrun3', ['ZeroBias2023RAW13.0', 'hcalDPGNANO_data13.0']]
# workflows[_wfn()] = ['hcalDPGCalibNANO130Xrun3', ['TestEnablesEcalHcal2023RAW13.0', 'hcalDPGCalibNANO_data13.0']]
