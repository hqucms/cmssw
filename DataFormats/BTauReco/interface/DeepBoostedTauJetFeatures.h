#ifndef DataFormats_BTauReco_DeepBoostedTauJetFeatures_h
#define DataFormats_BTauReco_DeepBoostedTauJetFeatures_h
...
class DeepBoostedTauJetFeatures {
...
public:
  ...
  void fill(const std::string& name, float value){
    ...
    if (item != feature_map_.end()){
      ...
      throw cms::Exception("InvalidArgument") << "[DeepBoostedTauJetFeatures::fill()] Feature " << name << " has not been registered";
    }
  }
  ...
  const std::vector<float>& get(const std::string& name) const {
    ...
    if (item != feature_map_.end()){
      ...
      throw cms::Exception("InvalidArgument") << "[DeepBoostedTauJetFeatures::get()] Feature " << name << " does not exist!";
    }
  }
...
#endif // DataFormats_BTauReco_DeepBoostedTauJetFeatures_h
